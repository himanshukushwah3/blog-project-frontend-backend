...
const axiosInstance = axios.create({
  baseURL: API_URL,
  timeout: 10000, // wait 10 sec before canceling the request if no response is received.
  headers: {
    "content-type": "application/json",
  },
});

// Interceptors - Functions that run before a request is sent or after a response is received.
...
for (const [key, value] of Object.entries(API_SERVICE_URL)) {
